...
const Search = ({ ...props }) => {
    return <div className="search">
        <input type="text" className="search__input" placeholder="Поиск..." {...props} />
        <svg width="21" height="21" viewBox="0 0 21 21" fill="none" className="search__icon" xmlns="http://www.w3.org/2000/svg">
